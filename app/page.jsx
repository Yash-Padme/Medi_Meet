...
// inside a big div we created multiple div and divide into different sections 
//  
...
export default function Home() {
  return (
    <div className="bg-background">
      ...
      {/* image div */}
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[700px] rounded-xl overflow-hidden">
              <Image
                src="/banner2.png"
      ...
      {/* Features Section using data.js from lib */}
...
{/* // used card component from shadcn/ui */}
      ...
      {/* // This section uses the Pricing component to display consultation packages */}
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto">
            {/* Clerk Pricing Table */}
            {/* pricing is handled by the Pricing component */}
            {/* This component displays different consultation packages */}
            <Pricing />
