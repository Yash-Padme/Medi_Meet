...
// OnboardingPage component for user role selection and doctor registration
// This component allows users to choose their role (Patient or Doctor) and provides a form for doctors to fill out their professional details for verification.
// It uses React Hook Form for form handling and Zod for validation, along with custom hooks for server actions.
// It also handles navigation using Next.js router and displays loading states during server actions.
